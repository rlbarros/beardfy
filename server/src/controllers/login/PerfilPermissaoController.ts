...
export class PerfilPermissaoController implements Controller{
  initialize(httpServer: HttpServer): void {
    ...
    httpServer.post('/login/perfilPermissao/:idPerfil/:idPermissao', this.create.bind(this));
  ...
  private async getById(req: Request, res: Response): Promise<void> {
    ...
    const perfilPermissao = await perfilPermissaoService.getById(req.params.id);
